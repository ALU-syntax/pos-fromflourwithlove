...
<div class="modal fade" id="modall" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Logs Barang "<span id="namabarang"></span>"</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<script>
    ...
    $('#bahan').select2({
        ...
        ajax: {
            ...
            data: function(params) {
                var bahanArray = $('input[name="bahan[]"]').map(function() {
                    return $(this).val();
                }).get();
    ...
    $("#bahan").on('select2:select', function() {
        $.ajax({
            type: "POST",
            url: "/produk/getDataBahan",
            data: {
                id: $(this).val()
            },
            dataType: "JSON",
