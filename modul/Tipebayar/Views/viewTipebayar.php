...
<div class="page-heading">
    <div class="row">
        <div class="col-6">
            <h3>Daftar Tipe Bayar</h3>
        </div>
        <div class="col-6 text-end">
            <button class="btn btn-primary" onclick="tambah()"><i class="fa fa-plus"></i>&nbsp; Tambah Tipe</button>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form id="form" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama tipe pembayaran">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        <label for="icon" class="form-label">Icon</label>
                        <input type="text" class="form-control" id="icon" name="icon" placeholder="Contoh: bi bi-cash">
                        <div class="invalid-feedback"></div>
                        <p class="mt-3">Dapatkan icon <a href="https://fontawesome.com/v5/search?o=r&m=free" target="_blank" style="text-decoration: underline;">disini</a></p>
                    </div>
            </div>
...
<div class="modal fade" id="modald" tabindex="-1" aria-labelledby="modaldLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaldLabel">Hapus data tipe bayar "<span><strong id="tipe"></strong></span>"</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('#nama').val(response.data.nama_tipe);
                    $('#icon').val(response.data.icon);
                    $('#title').text('Edit Tipe Bayar');
                    modal.modal('show');
                }
            },
