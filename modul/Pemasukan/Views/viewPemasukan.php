...
<div class="page-heading">
    <div class="row">
        ...
        <div class="col-6 text-end">
            <button class="btn btn-primary" onclick="tambah()"><i class="fa fa-plus"></i>&nbsp; Tambah Pemasukan</button>
        </div>
    </div>
</div>
                ...
                <form id="form" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kategori" id="kategori">
                            <option disabled selected>Pilih kategori pemasukan</option>
                    ...
                    <div class="mb-3">
                        <label for="jumlah" class="form-label">Total Pemasukan</label>
                        <input type="text" class="form-control harga" id="jumlah" name="jumlah" placeholder="Masukkan jumlah pemasukan">
                        <div class="invalid-feedback"></div>
                    </div>
                    <hr>
...
<div class="modal fade" id="modald" tabindex="-1" aria-labelledby="modaldLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaldLabel">Hapus data pemasukan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<script>
    ...
    function tambah() {
        ...
        $('#title').text('Tambah data pemasukan');
        modal.modal('show');
    }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('#foto').val(null);
                    $('#preview').html('<img src="/assets/img/pemasukan/' + response.data.foto + '" alt="Preview Gambar" class="img-preview rounded">');

                    $('#id').val(response.data.id);
                    $('#kategori').val(response.data.id_kategori_pemasukan).attr('selected', 'selected');
                    ...
                    $('#title').text('Edit data pemasukan');
                    modal.modal('show');
                }
            },
