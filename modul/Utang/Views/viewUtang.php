...
<div class="page-heading">
    <div class="row">
        ...
        <div class="col-6 text-end">
            <button class="btn btn-primary" onclick="tambah()"><i class="fa fa-plus"></i>&nbsp; Tambah Utang</button>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form" autocomplete="off">
                    ...
                    <div class="mb-3">
                        <label for="pelanggan" class="form-label">Menerima dari :</label>
                    ...
                    <div class="mb-3">
                        <label for="jumlah" class="form-label">Menerima sejumlah</label>
                        <input type="text" class="form-control harga" id="jumlah" name="jumlah" placeholder="Masukkan jumlah utang">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback"></div>
                        <p class="text-muted mt-1" style="font-size: x-small;">Silakan upload foto yang berkaitan dengan utang ini.</p>
                        <div id="preview"></div>
                    </div>
                    <div class="mb-3">
                        <label for="foto" class="form-label">Catatan</label>
                        <input type="text" class="form-control" name="catatan" id="catatan" placeholder="Cth: Hutang pembelian pulsa"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modalb" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="title">Daftar Bayar Utang "<span class="pelanggan"></span>"</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="card mb-2 mt-2" style="background-color: #f2f7ff;">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                Status : &nbsp;<span id="statusutang"></span>
                            </div>
                            <div class="col-4">
                                Sudah Bayar : &nbsp;<span id="sudahbayar" style="text-decoration: underline;"></span>
                            </div>
                            <div class="col-4">
                                Sisa Utang : &nbsp;<span id="sisa" style="text-decoration: underline;"></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modald" tabindex="-1" aria-labelledby="modaldLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaldLabel">Hapus data utang "<span id="hutanghapus"></span>"</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('#foto').val(null);
                    $('#preview').html('<img src="/assets/img/utang/' + response.data.foto + '" alt="Preview Gambar" class="img-preview rounded">');
    ...
    function updateBayar(id_utang) {
        var form = $('#formbyr')[0];
        var formData = new FormData(form);
        formData.append('id_utang', id_utang);
        $.ajax({
            type: "POST",
            url: "/utang/updateBayar",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
    ...
    function hapusBayar(id, jumlah, foto, id_utang) {
        Swal.fire({
            title: 'Hapus Data Ini?',
            text: "Tindakan ini akan berpengaruh pada status hutang",
            icon: 'warning',
